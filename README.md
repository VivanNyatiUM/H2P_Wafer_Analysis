...
Alignment and Device Image Creation (use --bound --bound-exact-jpeg-decode --bound-workers 3 for higher quality and perfectly cropped images):
```powershell
...
| `1`–`5` | Assign class in standard typed mode only (no --quick-review) |
