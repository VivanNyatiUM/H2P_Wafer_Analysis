...
WAFER_EXTRACTION_VERSION = 'bound-crop-v6-parallel-2026-07-15+per-wafer-output-v22'
...
def parse_batch_file(filepath: str) -> list[dict]:
    # Parse compact wafer-name lists or legacy four-line batch blocks.
    from batch_wafers_parser import parse_batch_file as _parse_batch_file

    return _parse_batch_file(filepath)
